...
import edu.emory.mathcs.nlp.common.collection.dialog.Scene;
import edu.emory.mathcs.nlp.common.collection.dialog.Utterance;
...
public class SceneTSVReader{
	...
	private void toUtterance(Map<Integer, Utterance> m_utterances, List<String[]> l_fileds) throws IOException{
		int uid = Integer.parseInt(l_fileds.get(0)[utterance_id]);
		StatementNode[] nodes = toNodeList(l_fileds);
