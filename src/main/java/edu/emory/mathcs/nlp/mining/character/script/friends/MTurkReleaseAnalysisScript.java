...
import edu.emory.mathcs.nlp.mining.character.script.util.analysis.RuledBasedFirstPRPAnalyzer;
 ...
 * @since 	Mar 20, 2016
 */
public class MTurkReleaseAnalysisScript {
	public static final int NUM_QUESTION 	= 50;
	
	public static final String
		I_DIR  = "/Users/HenryChen/Desktop/BigBang/season1/annotated",
		T_EXT  = ".dep", S_EXT  = ".spk";
	...
	public static void main(String[] args) throws Exception{
		...
		RuledBasedFirstPRPAnalyzer analyzer = new RuledBasedFirstPRPAnalyzer();
		for(Season season : seasons){
			for(Episode episode : season){
				for(Scene scene : episode){
					System.out.println(String.format("Analyzing s%d-e%d-s%d", season.getID(), episode.getID(), scene.getID()));
