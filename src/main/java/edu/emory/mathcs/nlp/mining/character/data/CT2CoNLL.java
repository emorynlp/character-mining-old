...
public class CT2CoNLL
{
	...
	{
		List<String> paths = FileUtils.getFileList("/Users/HenryChen/Desktop/TV_Show_Tanscripts/Friends/season1_ctree", ".cnst");
		String outputFile;
				
		CT2CoNLL c2n = new CT2CoNLL();
		for(String path : paths){
			System.out.println(path);
			outputFile = FileUtils.replaceExtension(path, "conll");
			c2n.transform(path, outputFile);
		}		
	}
}